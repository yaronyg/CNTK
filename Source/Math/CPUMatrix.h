...
public:
    ...
    void PSROIPoolingForward(const size_t numRois, const size_t numImg, const size_t groupSize, const size_t inChannels, const size_t outChannels,
    ...
    void PSROIPoolingBackward(const size_t numRois, const size_t numImg, const size_t channels, const size_t width, const size_t height,
        const size_t pooledWidth, const size_t pooledHeight, const CPUMatrix<ElemType>& roiData, CPUMatrix<ElemType>& grad, CPUMatrix<ElemType>& workspace) const;
