...
namespace CNTK
{
    ...
    ProgressConfig::ProgressConfig(const std::vector<ProgressWriterPtr>& progressWriters, size_t progressFrequency):
        m_frequency(progressFrequency),
        m_writers(progressWriters)
    {
    }
